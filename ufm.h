...
#define UFM_TOKENS \
    ...
    ( ( Extension, "png" ) ) \
    ( ( Params, "ufmParams" ) )
TF_DECLARE_PUBLIC_TOKENS(ufmTokens, UFM_TOKENS);

#define UFM_PARAM_NAMES \
    ( ( cubesX, "cubesX" ) )\
    ( ( cubesY, "cubesY" ) )\
    ( ( cubesZ, "cubesZ" ) )\
    ( ( randomRotY, "randomRotY" ) )
TF_DECLARE_PUBLIC_TOKENS(ufmParamNames, UFM_PARAM_NAMES);

TF_DECLARE_WEAK_AND_REF_PTRS(ufm);

class ufm : public pxr::SdfFileFormat, public pxr::PcpDynamicFileFormatInterface
{
public:
